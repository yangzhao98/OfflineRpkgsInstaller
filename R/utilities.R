...
download_r_packages <- function(cran_pkgs = NULL, github_repos = NULL, bioc_pkgs = NULL, dest_dir) {
...
#' @import utils
#' @export
package_offline_bundle <- function(cran_pkgs = NULL, github_repos = NULL, bioc_pkgs = NULL, dest_dir, bundle_name) {
